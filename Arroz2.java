...
public class Arroz_alineado extends JFrame {
   ...
   private void calcular() {
       try {
        ...
        // Determinar los caramelos de regalo
           ...
           resultado += "=======================\n\n";
           resultado += String.format("%-90s: %s\n", "Marca de arroz", MarcaArroz);
           resultado += String.format("%-90s: S/. %.2f\n", "Precio Unitario", precioUnitario);
           resultado += String.format("%-90s: %d botellas\n", "Cantidad", cantidad);
           resultado += String.format("%-90s: S/. %.2f\n", "Importe de Compra", importeCompra);
           resultado += String.format("%-90s: %.2f%%\n", "Porcentaje de Descuento", porcentajeDescuento);
           resultado += String.format("%-90s: S/. %.2f\n", "Importe del Descuento", importeDescuento);
           resultado += String.format("%-90s: S/. %.2f\n", "Importe a Pagar", importePagar);
           resultado += String.format("%-90s: Caramelos %d Gomitas %d\n", "Obsequios", Obsequio, Obsequio2);
